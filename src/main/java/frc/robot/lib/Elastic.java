...
public final class Elastic {
	 ...
	 *
	 * @param notification
	 *            the {@link Notification} object containing notification details
	 */
	...
	public static class Notification {
		 ...
		 *
		 * @param level
		 *            the level of the notification (e.g., INFO, WARNING, ERROR)
		 * @param title
		 *            the title text of the notification
		 * @param description
		 *            the descriptive text of the notification
		 * @param displayTimeMillis
		 *            the time in milliseconds for which the notification is displayed
		 * @param width
		 *            the width of the notification display area
		 * @param height
