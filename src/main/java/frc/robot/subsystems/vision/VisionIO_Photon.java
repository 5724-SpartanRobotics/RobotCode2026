...
public class VisionIO_Photon implements VisionIO {
	 ...
	 */
	public VisionIO_Photon(CameraConfigurations cam) {
		camera = new PhotonCamera(cam.getName());
		this.robotToCamera = cam.getTransform3d();
	}
	...
	public void updateInputs(VisionIOInputs inputs) {
		...
		for (var result : camera.getAllUnreadResults()) {
			...
			if (result.hasTargets()) {
				...
				inputs.latestTargetObservation = new TargetObservation(new Rotation2d(),
					new Rotation2d());
			}
